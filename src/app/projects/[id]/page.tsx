            ...
            <div className="space-y-3">
              {project.location && (
                <p className="text-gray-300">
                  <span className="text-[#C6A87D]">Location:</span>{" "}
                  {project.location}
                </p>
              )}
              {project.year && (
                <p className="text-gray-300">
                  <span className="text-[#C6A87D]">Year:</span> {project.year}
                </p>
              )}
            </div>
          </div>
        ...
        <div className="mb-8" ref={previewRef}>
          {selectedImage && (
            <img
              src={selectedImage}
              alt={project.name}
              className="w-full h-[600px] md:h-[600px] object-contain sm:object-cover rounded-lg shadow-xl"
            />
          )}
        </div>
