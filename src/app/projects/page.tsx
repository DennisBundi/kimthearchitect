        ...
        <section className="container mx-auto px-4 py-12">
          <div className="flex gap-4 mb-12">
            <button 
              ...
              className={`${activeCategory === 'all' ? 'bg-[#C6A87D]' : 'bg-gray-700'} px-6 py-2 rounded-lg text-white hover:opacity-90 transition-opacity`}
            >
              All
            </button>
            <button 
              onClick={() => setActiveCategory('Commercial')}
              className={`${activeCategory === 'Commercial' ? 'bg-[#C6A87D]' : 'bg-gray-700'} px-6 py-2 rounded-lg text-white hover:opacity-90 transition-opacity`}
            >
              Commercial
            </button>
            <button 
              onClick={() => setActiveCategory('Residential')}
              className={`${activeCategory === 'Residential' ? 'bg-[#C6A87D]' : 'bg-gray-700'} px-6 py-2 rounded-lg text-white hover:opacity-90 transition-opacity`}
            >
              Residential
            </button>
          </div>
