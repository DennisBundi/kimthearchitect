    ...
    <div className="bg-[#1A1F2E] min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          ...
          >
            <motion.h1 
              ...
              className="text-6xl md:text-7xl font-light text-white mb-6 leading-tight"
            >
              ELEVATING<br />
            ...
            >
              Creating timeless spaces that blend innovative design with functional excellence. 
          ...
          >
            <motion.div {...fadeIn} className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                With over a decade of experience in architectural excellence, we bring your vision to life through innovative design and meticulous attention to detail.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h3 className="text-3xl font-light text-[#DBA463] mb-2">150+</h3>
                  <p className="text-gray-600">Projects Completed</p>
                </div>
                <div>
                  <h3 className="text-3xl font-light text-[#DBA463] mb-2">12+</h3>
      ...
      <section ref={servicesRef} className="relative py-24 bg-[#1A1F2E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h2 {...fadeIn} className="text-4xl font-light text-white mb-4">
            ...
            {[
              {
                ...
                description: 'Creating innovative and functional spaces that inspire.',
                icon: '🏛️'
              },
              {
                title: 'Interior Planning',
                description: 'Crafting beautiful and practical interior spaces.',
                icon: '🎨'
              },
              {
